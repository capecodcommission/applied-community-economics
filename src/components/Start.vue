...
export default {
  ...
  watch: {
    ...
    'censusTowns': function(x) {
      ...
      // Adding FlareClusterLayer folder from GitHub to node_modules immediately breaks app
      // var options = {
      ...
      //     packages: [
      //       {
      //         location: '/node_modules/FlareClusterLayer/fcl',
      //         name: 'fcl'
      //       }
      //     ]
      //   }
        ...
        "dojo/domReady!"
          ...
          //,FlareClusterLayer
            ...
            var acBoundaries = new FeatureLayer ({
              url: "http://gis-services.capecodcommission.org/arcgis/rest/services/ActivityCenters/CommunityCharacteristics/MapServer/2",
              outFields: ['*'],
              visible: false,
              popupTemplate: {
                content: '{*}'
