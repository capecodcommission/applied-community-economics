...
var wmvp3_DBConfig = {
  user: process.env.wmvp_user,
  password: process.env.wmvp_password,
  server: process.env.wmvp_server,
  port: parseInt(process.env.wmvp_port),
  database: process.env.wmvp_database,
  stream: true,
...
var wqm_DBConfig = {
  user: process.env.wqm_user,
  password: process.env.wqm_password,
  server: process.env.wqm_server,
  port: parseInt(process.env.wqm_port),
  database: process.env.wqm_database,
  stream: true,
  requestTimeout: 300000,
  connectionTimeout: 300000,
  pool: {
...
var tm_DBConfig = {
  ...
  server: process.env.tm_server,
  port: parseInt(process.env.tm_port),
...
var comchar_DBConfig = {
  ...
  server: process.env.ace_server,
  port: parseInt(process.env.ace_port),
  database: process.env.ace_database,
  stream: true,
  requestTimeout: 300000,
  connectionTimeout: 300000,
  pool: {
